...
function LoginPage() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    function handlePassowrdReset(){
      const email = prompt('Por favor insira o seu e-mail');
      sendPasswordResetEmail(auth, email);
      alert('E-mail enviado! Verifique a caixa de entrada do e-mail para obter instruções de redefinição de senha')
    }
        ...
        <div className="container login-page">
          <section>
            ...
            <form className="add-form login">
                  ...
                  <p onClick = {handlePassowrdReset} className = "forgot-password">Forgot Password?</p>
